            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = [['label' => 'ID', 'width' => 5], 'Morador', 'Condomínio', 'Bloco', 'Apartamento', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/residents'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'user_name', 'name' => 'user_name'], ['data' => 'complex_name', 'name' => 'complex_name'], ['data' => 'block_name', 'name' => 'block_name'], ['data' => 'apartment_name', 'name' => 'apartment_name'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
