                            ...
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                ...
                                @can('Criar Apartamentos')
                                    <a href="{{ route('admin.apartments.create') }}" title="Novo Apartamento"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Novo Apartamento</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Nome', 'Bloco', 'Condomínio', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/apartments'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'block_name', 'name' => 'block_name'], ['data' => 'complex_name', 'name' => 'complex_name'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
