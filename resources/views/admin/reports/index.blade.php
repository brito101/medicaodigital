...
@section('title', '- Relatórios de Consumo')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-file"></i> Relatórios de Consumo</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Relatórios de Consumo</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Relatórios de Consumo Cadastrados</h3>
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Condomínio', 'Data de Referência', 'Consumo', 'Valor', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/bills'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'complex_name', 'name' => 'complex_name'], ['data' => 'date_format', 'name' => 'date_ref'], ['data' => 'consumption_format', 'name' => 'consumption'], ['data' => 'value_format', 'name' => 'value'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
