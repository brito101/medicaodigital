                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    <div class="col-12 col-md-8 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="name"
                                            placeholder="Nome do Condomínio" name="name"
                                            value="{{ old('name') ?? $complex->name }}" required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="document_company" placeholder="CNPJ"
                                            ...
                                            value="{{ old('document_company') ?? $complex->document_company }}">
                                    </div>

                                    <div class="col-12 col-md-3 form-group px-0 px-md-2">
                                        <label for="email">E-mail</label>
                                        <input type="email" class="form-control" id="email" placeholder="E-mail"
                                            name="email" value="{{ old('email') ?? $complex->email }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="neighborhood"
                                            ...
                                            value="{{ old('neighborhood') ?? $complex->neighborhood }}">
                                    </div>

                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        <label for="city">Cidade</label>
                                        <input type="text" class="form-control" id="city" placeholder="Cidade"
                                            name="city" value="{{ old('city') ?? $complex->city }}">
                                    </div>
