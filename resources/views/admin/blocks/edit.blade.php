...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-building"></i> Editar Bloco</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.blocks.index') }}">Blocos</a></li>
                        <li class="breadcrumb-item active">Editar Bloco</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-12 col-md-6 form-group px-0 pl-md-2 mb-0">
                                        ...
                                        <x-adminlte-select2 name="complex_id">
                                            @foreach ($complexes as $complex)
                                                <option
                                                    {{ old('complex_id') == $complex->id ? 'selected' : ($block->complex_id == $complex->id ? 'selected' : '') }}
                                                    value={{ $complex->id }}>
                                                    {{ $complex->name }}</option>
                                            @endforeach
                                        </x-adminlte-select2>
